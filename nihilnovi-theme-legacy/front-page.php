...
<section class="nn-hero" id="inicio" aria-label="Portada">
  ...
  <div class="hero-graphic" aria-hidden="true">
    <svg viewBox="0 0 500 500" fill="none" stroke="var(--gold)" stroke-width="1.2" class="nn-geometry-svg">
      <!-- Ejes coordenados de fondo -->
      <line x1="50" y1="250" x2="450" y2="250" stroke-dasharray="3,6" opacity="0.3" />
      <line x1="250" y1="50" x2="250" y2="450" stroke-dasharray="3,6" opacity="0.3" />
      
      <!-- Círculos concéntricos (Esferas concéntricas / Astrolabio) -->
      <circle cx="250" cy="250" r="180" opacity="0.25" />
      <circle cx="250" cy="250" r="130" opacity="0.4" />
      <circle cx="250" cy="250" r="80" opacity="0.55" />
      <circle cx="250" cy="250" r="30" opacity="0.7" />
      
      <!-- Líneas de cuadrante -->
      <line x1="122" y1="122" x2="378" y2="378" opacity="0.3" />
      <line x1="122" y1="378" x2="378" y2="122" opacity="0.3" />
      
      <!-- Órbitas / Elipses matemáticas cruzadas -->
      <ellipse cx="250" cy="250" rx="180" ry="60" transform="rotate(30 250 250)" opacity="0.35" />
      <ellipse cx="250" cy="250" rx="180" ry="60" transform="rotate(-30 250 250)" opacity="0.35" />
      <ellipse cx="250" cy="250" rx="180" ry="60" transform="rotate(90 250 250)" opacity="0.2" />

      <!-- Puntos de constelación de conocimiento -->
      <circle cx="378" cy="122" r="4.5" fill="var(--gold)" opacity="0.9" />
      <circle cx="122" cy="378" r="4.5" fill="var(--gold)" opacity="0.9" />
      <circle cx="250" cy="70" r="4.5" fill="var(--gold)" opacity="0.9" />
      <circle cx="250" cy="430" r="4.5" fill="var(--gold)" opacity="0.9" />
      <circle cx="430" cy="250" r="4.5" fill="var(--gold)" opacity="0.9" />
    </svg>
  </div>

  <!-- Segundo Gráfico: Sólidos Platónicos Flotantes (Fondo Lado Izquierdo) -->
  <div class="hero-graphic-2" aria-hidden="true">
    <svg viewBox="0 0 500 500" fill="none" stroke="var(--gold)" stroke-width="1.2" class="nn-platonic-svg">
      <!-- Pentágono Exterior del Icosaedro -->
      <polygon points="250,90 402,200 344,380 156,380 98,200" stroke="var(--gold)" stroke-width="1.2" opacity="0.45" />
      <!-- Pentágono Interior del Icosaedro -->
      <polygon points="250,160 335,220 303,320 197,320 165,220" stroke="var(--gold)" stroke-width="1.2" opacity="0.65" />
      <!-- Conexiones radiales -->
      <line x1="250" y1="90" x2="250" y2="160" stroke="var(--gold)" stroke-width="1.2" opacity="0.6" />
      <line x1="402" y1="200" x2="335" y2="220" stroke="var(--gold)" stroke-width="1.2" opacity="0.6" />
      <line x1="344" y1="380" x2="303" y2="320" stroke="var(--gold)" stroke-width="1.2" opacity="0.6" />
      <line x1="156" y1="380" x2="197" y2="320" stroke="var(--gold)" stroke-width="1.2" opacity="0.6" />
      <line x1="98" y1="200" x2="165" y2="220" stroke="var(--gold)" stroke-width="1.2" opacity="0.6" />
      <!-- Diagonales y triangulación interior-exterior -->
      <line x1="250" y1="90" x2="335" y2="220" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="402" y1="200" x2="303" y2="320" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="344" y1="380" x2="197" y2="320" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="156" y1="380" x2="165" y2="220" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="98" y1="200" x2="250" y2="160" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="250" y1="90" x2="165" y2="220" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="98" y1="200" x2="197" y2="320" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="156" y1="380" x2="303" y2="320" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="344" y1="380" x2="335" y2="220" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <line x1="402" y1="200" x2="250" y2="160" stroke="var(--gold)" stroke-width="1.2" opacity="0.55" />
      <!-- Estructura del núcleo -->
      <line x1="250" y1="160" x2="303" y2="320" stroke="var(--gold)" stroke-width="1.2" opacity="0.75" />
      <line x1="335" y1="220" x2="197" y2="320" stroke="var(--gold)" stroke-width="1.2" opacity="0.75" />
      <line x1="303" y1="320" x2="165" y2="220" stroke="var(--gold)" stroke-width="1.2" opacity="0.75" />
      <line x1="197" y1="320" x2="250" y2="160" stroke="var(--gold)" stroke-width="1.2" opacity="0.75" />
      <line x1="165" y1="220" x2="335" y2="220" stroke="var(--gold)" stroke-width="1.2" opacity="0.75" />
    </svg>
  </div>
...
<!-- ══════════ EL VIAJE ══════════ -->
<section class="nn-viaje fade" id="viaje" aria-label="El Viaje del Economista">
  ...
  <div class="viaje-inner">
    ...
    <div class="steps">
      <div class="step">
        ...
        <div class="step-body">
          <strong>Historia del Pensamiento Económico</strong>
          <p>Antes de los modelos, la genealogía. Quién construyó las herramientas y por qué.</p>
        </div>
      </div>
      <div class="step">
        ...
        <div class="step-body">
          ...
          <p>La lógica de las decisiones individuales. El lenguaje base sin el que no se puede leer ningún paper.</p>
        </div>
      </div>
      <div class="step">
        ...
        <div class="step-body">
          ...
          <p>Lo que pasa cuando las decisiones individuales se suman y producen algo que nadie quiso.</p>
        </div>
      </div>
      <div class="step">
        <span class="step-badge">IV</span>
        <div class="step-body">
          <strong>Estadística y Econometría</strong>
          <p>Sin esto, la economía es filosofía con gráficas. El lenguaje de la evidencia.</p>
        </div>
      </div>
      <div class="step">
        <span class="step-badge">V–VII</span>
        <div class="step-body">
          <strong>Matemáticas · Economía Política · Filosofía de la Ciencia</strong>
          <p>Los pilares que los programas universitarios no enseñan bien.</p>
        </div>
      </div>
    </div>
  </div>
