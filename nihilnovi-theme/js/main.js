...
(function () {
    ...
    (function initHeroParallax() {
        ...
        var scrollY = 0;
        var pos1    = 0; /* posición interpolada del círculo    */
        var pos2    = 0; /* posición interpolada del icosaedro  */
        ...
        function tickHero() {
            ...
            /* Lerp muy suave: multiplicadores bajos para que permanezcan en pantalla más tiempo.
               Ambas figuras ahora bajan levemente para contrarrestar el scroll y flotar. */
            ...
            if (graphic2) {
                if (isDesktop) {
                    ...
                    /* En móvil/vertical se mantiene centrado en X (-50%) pero flota en Y */
                    graphic2.style.transform = 'translate(-50%, calc(-50% + ' + pos2.toFixed(2) + 'px))';
                }
            }
